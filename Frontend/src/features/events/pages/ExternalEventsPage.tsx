/**
 * REFACTOR: consolidate-features
 * Phase: F1 - Migrate external to events
 * ID: F1-004
 * 
 * Original file: src/features/external/pages/ExternalEventsPage.tsx
 * Reason: Feature "external" is role-based, violates AGENTS.md pattern
 * 
 * @see https://github.com/RyuWilliam/Event-Tracker/pull/XXX
 */
...
import { useEvents, usePopularEvents, likeEvent, unlikeEvent, getMyFavorites, getAllCategories } from "@/features/events"
